/**
 * POST /api/paper-forward/sessions/[id]/complete
 * RUNNING or PAUSED → COMPLETED. Terminal states cannot restart.
 * Does not flatten leftover simulated positions. Does not place orders.
 */
...
export default asyncHandler(async (req: NextApiRequest, res: NextApiResponse) => {
  ...
  try {
    ...
    const session = await completePaperSession(
