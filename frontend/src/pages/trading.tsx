  ...
  const [recentTrades] = useState<Trade[]>([
    {
      ...
      price: 64500,
      pnl: 675,
      timestamp: "2026-04-14 10:30:15",
      signal: "RSI < 30 (Oversold)",
      claudeReason: "Market oversold after correction, historical data shows 78% win rate on this pattern in 1h timeframe",
    },
    {
      id: "2",
      symbol: "ETHUSDT",
      ...
      price: 3200,
      pnl: 427.5,
      timestamp: "2026-04-15 12:15:42",
      signal: "MACD Crossover",
      claudeReason: "MACD line crossed above signal line with volume confirmation, indicating strong bullish momentum shift",
    },
    {
      id: "3",
      symbol: "BNBUSDT",
      ...
      price: 620,
      pnl: 140,
      timestamp: "2026-04-15 14:45:08",
      signal: "SMA Golden Cross",
      claudeReason: "20-period SMA crossed above 50-period SMA on daily timeframe, strong uptrend signal confirmed",
    },
    {
      id: "4",
      symbol: "SOLUSDT",
      ...
      price: 158,
      pnl: 680,
      timestamp: "2026-04-13 08:22:33",
      signal: "RSI > 70 (Overbought)",
      claudeReason: "Overbought conditions detected, taking profits on strong 58% gain before pullback",
    },
  ]);
